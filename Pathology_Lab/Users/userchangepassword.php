                    ...
                    <div class="sidebar">
                        ...
                        <div class="appointment-block">
                            ...
                            <div class="bg-default widget-appointments">
                                <!--widget-appointments-->
                                <div class=" ">
                                    <h3 class="mb20">Enter details to change password</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="box-footer">
                                            <div class="text-right">
                                                <button type="submit" style="margin-right:3%;;" name="submit" id="submit" class="btn btn-default">Submit</button>
                                                <button type="reset" style="" name="reset" id="reset" class="btn btn-default">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
